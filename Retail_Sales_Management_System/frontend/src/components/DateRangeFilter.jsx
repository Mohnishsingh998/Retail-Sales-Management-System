  ...
  return (
    <div className="relative dropdown-wrapper whitespace-nowrap ">
      ...
      <button
        ...
        className="px-1 py-1.5 h-[26px] bg-[#F2F4F7] border border-[#D0D5DD] rounded-sm inline-flex items-center justify-between gap-2 text-xs text-gray-700 font-medium hover:bg-[#EAECF0] transition-colors whitespace-nowrap shrink-0 font-normal"
      >
        <span>Date</span>
